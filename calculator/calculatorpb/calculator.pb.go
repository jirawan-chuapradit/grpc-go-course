...
func (x *PrimeNumberManyTimesRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x03, 0x73, 0x75, 0x6d, 0x22, 0x35, 0x0a, 0x1b, 0x50, 0x72, 0x69, 0x6d, 0x65,
	...
	0x0a, 0x1c, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x4d, 0x61, 0x6e,
	...
	0x05, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x69, 0x6d, 0x75, 0x6d, 0x32, 0x88, 0x03, 0x0a, 0x11, 0x43,
	...
	0x71, 0x0a, 0x18, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x44, 0x65,
	0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x2e, 0x63, 0x61,
	...
	0x72, 0x2e, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x4d, 0x61, 0x6e,
	...
	0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x1a, 0x5a, 0x18, 0x2f, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*PrimeNumberManyTimesRequest)(nil),  // 2: calculator.PrimeNumberManyTimesRequest
	(*PrimeNumberManyTimesResponse)(nil), // 3: calculator.PrimeNumberManyTimesResponse
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	2, // 1: calculator.CalculatorService.PrimeNumberDecomposition:input_type -> calculator.PrimeNumberManyTimesRequest
	...
	1, // 4: calculator.CalculatorService.Calculator:output_type -> calculator.CalculatorResponse
	3, // 5: calculator.CalculatorService.PrimeNumberDecomposition:output_type -> calculator.PrimeNumberManyTimesResponse
...
type CalculatorServiceClient interface {
	...
	// Server Streaming
	PrimeNumberDecomposition(ctx context.Context, in *PrimeNumberManyTimesRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecompositionClient, error)
	// Client Streaming
...
func (c *calculatorServiceClient) PrimeNumberDecomposition(ctx context.Context, in *PrimeNumberManyTimesRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecompositionClient, error) {
...
func (x *calculatorServicePrimeNumberDecompositionClient) Recv() (*PrimeNumberManyTimesResponse, error) {
...
type CalculatorServiceServer interface {
	...
	// Server Streaming
	PrimeNumberDecomposition(*PrimeNumberManyTimesRequest, CalculatorService_PrimeNumberDecompositionServer) error
	// Client Streaming
...
func (*UnimplementedCalculatorServiceServer) PrimeNumberDecomposition(*PrimeNumberManyTimesRequest, CalculatorService_PrimeNumberDecompositionServer) error {
...
func (x *calculatorServicePrimeNumberDecompositionServer) Send(m *PrimeNumberManyTimesResponse) error {
